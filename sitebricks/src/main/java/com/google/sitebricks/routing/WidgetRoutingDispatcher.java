...
class WidgetRoutingDispatcher implements RoutingDispatcher {
    ...
    public Respond dispatch(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (page.isHeadless()) {
            ...
            respond = bindAndRespond(request, page, instance, uri);
        }
        if (respond == Respond.HEADLESS) {
    ...
    private void bindAndReply(HttpServletRequest request, HttpServletResponse response, PageBook.Page page,
    ...
    private Respond bindAndRespond(HttpServletRequest request, PageBook.Page page, Object instance, String uri) {
        Respond respond = respondProvider.get();
        //bind request
        binder.bind(request, instance);
