...
/**
 * Enables browsers making a simulated PUT and DELETE requests. Currently
 * browsers support making GET and POST requests. This
 * {@link javax.servlet.Filter} checks if a hidden field is set and renames HTTP
 * method, retrieved via
 * {@link javax.servlet.http.HttpServletRequest#getMethod()} to a method set in
 * the hidden field
 * 
 * @author Peter Knego
 */
...
class HiddenMethodFilter implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		// Request attribute name to signal that filtering was already done in a
		// request
